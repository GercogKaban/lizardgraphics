...
void LGraphics::LCubeBuffer::setBuffers()
{
    LOG_CALL
    verticesCount = 36; indicesCount = 0, textureCoordsCount = 2, normalsCount = 3; // временно 0
...
void LGraphics::LCubeBuffer::setVerts()
{
    LOG_CALL
...
void LGraphics::LCubeBuffer::setInds()
{
}
